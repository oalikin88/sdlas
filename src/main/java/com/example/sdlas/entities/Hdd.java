...
public class Hdd extends Storage implements Serializable {
    ...
    public Hdd(Long number, Date dateRegistration, String type, String tag, String manufactureNumber, int capacity, String fromPlace, Long pcNumber, boolean signEmployee, boolean signToBack, String registrationEndSign, String comment) {
